        ...
        <div className="w-full max-w-lg text-left  bg-white rounded-lg">
          ...
          <form className="size-full max-w-screen-sm max-h-[700px]">
            <div className="mb-5 relative">
              <label className="block mb-2 font-sans text-lg font-medium leading-6 text-black">
                Full Name
              </label>
              <input
                type="text"
            ...
            <button
              type="submit"
              className="w-full py-3 text-lg text-white font-sans font-medium bg-blue-700 rounded-lg"
            >
              Register
            </button>
          </form>
          <p className="mt-4 font-sans text-base font-medium leading-6 text-center">
            <a href="#" className="text-black hover:underline">
              By clicking the button, you agree to our Terms, Privacy Policy and
              Security Policy.
            </a>
          </p>
        </div>
